...
exports.getUserPosition = exports.setUserPosition = exports.getUser = exports.getPeerId = exports.setUserOffline = exports.setUserOnline = exports.deleteRoom = exports.getRoomParticipants = exports.cleanUp = exports.broadcastExcludeSender = void 0;
...
const cleanUp = (userId, roomId) => __awaiter(void 0, void 0, void 0, function* () {
...
const setUserPosition = (roomId, userId, posData) => __awaiter(void 0, void 0, void 0, function* () {
    yield redis_1.redis.hset(roomId, userId, JSON.stringify(posData));
});
exports.setUserPosition = setUserPosition;
const getUserPosition = (roomId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    const posData = yield redis_1.redis.hget(roomId, userId);
